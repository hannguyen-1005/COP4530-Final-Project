...
public:
    ...
    void addConnection(int device_id1, int device_id2);          // add a connection between two devices
    void removeConnection(int device_id1, int device_id2);       // remove a connection between two devices
